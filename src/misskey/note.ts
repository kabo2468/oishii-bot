import { extract, type MfmNode, toString as mfmToString, parse } from 'mfm-js';
import type { Bot } from '../bot.js';
import type NGWord from '../ng-words.js';
import type { UserLite } from './api.js';
...
export class Note {
  ...
  reply({
    ...
    this.#bot.api
      .postText({ text: _t, visibility, replyId: this.note.id, cw })
      .catch((err) => {
        throw err;
      });
  }
