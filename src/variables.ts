export default {
    food: {
        ...
        foods: [
            { emoji: '🍇', keywords: ['grapes', 'ぶどう'] },
            { emoji: '🍈', keywords: ['melon', 'メロン'] },
            { emoji: '🍉', keywords: ['watermelon', 'スイカ'] },
            { emoji: '🍊', keywords: ['tangerine', 'オレンジ', 'みかん'] },
            { emoji: '🍋', keywords: ['lemon', 'レモン'] },
            { emoji: '🍌', keywords: ['banana', 'バナナ'] },
            { emoji: '🍍', keywords: ['pineapple', 'パイナップル'] },
            { emoji: '🥭', keywords: ['mango', 'マンゴー'] },
            { emoji: '🍎', keywords: ['red apple', 'りんご'] },
            { emoji: '🍏', keywords: ['green apple', '青りんご'] },
            { emoji: '🍐', keywords: ['pear', 'なし', '梨'] },
            { emoji: '🍑', keywords: ['peach', 'もも', '桃'] },
            { emoji: '🍒', keywords: ['cherries', 'さくらんぼ'] },
            { emoji: '🍓', keywords: ['strawberry', 'いちご'] },
            ...
            { emoji: '🍻', keywords: ['clinking beer mugs', 'ビールで乾杯'] },
